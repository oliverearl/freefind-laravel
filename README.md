# This is my package freefind-laravel
...
```bash
php artisan vendor:publish --tag="freefind-laravel-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="freefind-laravel-views"
```

## Usage

```php
$freefind = new Freefind\Freefind();
echo $freefind->echoPhrase('Hello, Freefind!');
```
